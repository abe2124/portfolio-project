...
class Users(db.Model):
    ...
    last_login = db.Column(db.String(255), nullable=True)
...
class Issues(db.Model):
    ...
    descriprion = db.Column(db.String(255))
    ...
    assigned_date = db.Column(db.String(255), nullable=True)
    solved_date = db.Column(db.String(255), nullable=True)
